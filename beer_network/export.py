...
def _process_to_dict(process: ProcessSnapshot) -> dict[str, object]:
    return {
        ...
        "estimated_upload_bps": process.estimated_upload_bytes_per_second,
        "estimated_download_bps": process.estimated_download_bytes_per_second,
